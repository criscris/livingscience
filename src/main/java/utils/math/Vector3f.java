...
public class Vector3f extends Tuple3f implements java.io.Serializable {
    ...
    public Vector3f(Tuple4f t1) {
        super(t1.x, t1.y, t1.z);
     }
   ...
   /**
    ...
    public final float distanceTo(Vector3f otherPos)
    {
    	float dx = x - otherPos.x;
    	float dy = y - otherPos.y;
    	float dz = z - otherPos.z;
    	
        return (float) Math.sqrt(dx*dx + dy*dy + dz*dz);
    }
    
    public final float sqDistanceTo(Vector3f otherPos)
    {
    	float dx = x - otherPos.x;
    	float dy = y - otherPos.y;
    	float dz = z - otherPos.z;
